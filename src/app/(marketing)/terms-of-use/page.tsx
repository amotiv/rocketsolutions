    ...
    <div className="min-h-screen bg-surface dark:bg-slate-900 py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
         <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 sm:p-12 border border-slate-200 dark:border-slate-800 shadow-sm">
            <h1 className="text-3xl sm:text-4xl font-bold text-navy dark:text-white mb-8 border-b border-slate-200 dark:border-slate-800 pb-6">Terms of Use</h1>
            ...
            <div className="prose prose-slate max-w-none text-slate-600 dark:text-slate-300 space-y-8">
               ...
               <section>
                  <h2 className="text-xl font-bold text-navy dark:text-white mb-3">1. Agreement to Terms</h2>
                  <p>
               ...
               <section>
                  <h2 className="text-xl font-bold text-navy dark:text-white mb-3">2. Informational Nature & No Guarantees</h2>
                  <p>
               ...
               <section>
                  <h2 className="text-xl font-bold text-navy dark:text-white mb-3">3. Intellectual Property Ownership</h2>
                  <p>
               ...
               <section>
                  <h2 className="text-xl font-bold text-navy dark:text-white mb-3">4. Limitation of Liability</h2>
                  <p>
               ...
               <section>
                  <h2 className="text-xl font-bold text-navy dark:text-white mb-3">5. Non-Client Status</h2>
                  <p>
               ...
               <section>
                  <h2 className="text-xl font-bold text-navy dark:text-white mb-3">6. Contact Information</h2>
